 ...
 * Original file: packages/inputmethods/PinyinIME/lib/com/android/inputmethod/pinyin/IPinyinDecoderService.aidl
 */
package com.xcd.pinyin;
public interface IPinyinDecoderService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.xcd.pinyin.IPinyinDecoderService
{
private static final java.lang.String DESCRIPTOR = "com.xcd.pinyin.IPinyinDecoderService";
...
/**
 * Cast an IBinder object into an com.xcd.pinyin.IPinyinDecoderService interface,
 * generating a proxy if needed.
 */
public static com.xcd.pinyin.IPinyinDecoderService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.xcd.pinyin.IPinyinDecoderService))) {
return ((com.xcd.pinyin.IPinyinDecoderService)iin);
}
return new com.xcd.pinyin.IPinyinDecoderService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.xcd.pinyin.IPinyinDecoderService
{
