...
//        System.out.println("wanghui=======onTouchEvent ACTION_MOVE MotionEvent====111=CandidateView==");
...
//            int bottom = mEnvironment.getSkbHeight()+(mEnvironment.getSkbHeight()-yDown);
//            int paddingBottom = mEnvironment.getScreenHeight()-bottom;
//            System.out.println("wanghui=======onTouchEvent ACTION_MOVE MotionEvent====222=CandidateView=mEnvironment.getSkbHeight():="+mEnvironment.getSkbHeight()+" mEnvironment.getHeightForCandidates():="+mEnvironment.getHeightForCandidates()+" bottom:="+bottom);
//            System.out.println("wanghui=======onTouchEvent ACTION_MOVE MotionEvent====222=CandidateView==YmoveRow:="+YmoveRow+" XmoveRow:="+XmoveRow+" XDownRow:="+XDownRow+" xDown:="+xDown);
//            if(YmoveRow < paddingBottom && YmoveRow > mEnvironment.getHeightForCandidates()+100)
//            {
//                if(y < 0)
//                {
//                    y1 = Math.abs(y);
...
//                x2 = x - xMoveRowold;
//                xMoveRowold = x;
//                System.out.println("wanghui=======onTouchEvent ACTION_MOVE MotionEvent======222=CandidateView=y2:="+y2+" y:="+y+"y1:="+y1+" x2:="+x2+" mPinyinIME:="+mPinyinIME);
//                if(mPinyinIME != null)
//                {
